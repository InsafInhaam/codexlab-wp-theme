    ...
    <div class="mi-invert-fix">
        ...
        <div class="container">
            <div class="mil-banner-content mil-up">
                ...
                <h1 class="mil-muted mil-mb-60">Excellence <span class="mil-thin">Delivered</span><br>
                    <span class="mil-thin">by Our </span>Expert<br>
                    <span class="mil-thin">Consultant </span>Team
                </h1>
                <div class="row">
                    <div class="col-md-7 col-lg-5">

                        <p class="mil-light-soft mil-mb-60">We provide cutting-edge design and development
                            services. Codex lab combines aesthetic finesse with technical skill for superior
                            digital solutions. Elevate your project with our expertise.
    ...
    <div class="container mil-p-120-30">
        <div class="row justify-content-between align-items-center">
            <div class="col-lg-6 col-xl-5">
                ...
                <div class="mil-mb-90">
                    <h2 class="mil-up mil-mb-60">Innovative solutions.
                        <br> <span class="mil-thin">Good Developers.
                        </span>
                    </h2>
                    <p class="mil-up mil-mb-30">We complement your vision of building the right product, by helping you
                        build it the right way.
                    </p>

                    <!-- <p class="mil-up mil-mb-60">Collaboration is at the heart of what we do. Our team
                        thrives on the synergy that arises when unique perspectives converge, fostering an
                        environment of boundless creativity. By harnessing our collective expertise, we
                        produce extraordinary results that consistently surpass expectations.</p> -->

                    <!-- <div class="mil-about-quote">
                                    <div class="mil-avatar mil-up">
                                        <img src="<?php echo get_template_directory_uri() ?>/img/faces/customers/2.jpg" alt="Founder">
                                    </div>
            ...
            <div class="col-lg-5">
                ...
                <div class="mil-about-photo mil-mb-90">
                    ...
                    <div class="mil-up mil-img-frame" style="padding-bottom: 160%;">
                        <img src="http://codexlab-theme.local/wp-content/uploads/2024/04/0x0.jpg" alt="img"
                            class="mil-scale" data-value-1="1" data-value-2="1.2">
                    </div>
                </div>
        ...
        <div class="container mil-p-120-0">
            ...
            <div class="mil-mb-120">
                ...
                <div class="mil-complex-text justify-content-center mil-up mil-mb-15">
                    ...
                    <!-- <span class="mil-text-image"><img src="<?php echo get_template_directory_uri() ?>/img/photo/2.jpg" alt="team"></span> -->
                    ...
                    <div class="row mil-mb-60">
                        <div class="col-sm-6">
                            ...
                            <div class="mil-team-card mil-up mil-mb-30">
                                <img src="<?php echo get_template_directory_uri() ?>/img/faces/1.jpg" alt="Team member">
                            ...
                            <div class="mil-team-card mil-up mil-mb-30">
                                <img src="<?php echo get_template_directory_uri() ?>/img/faces/3.jpg" alt="Team member">
                                <div class="mil-description">
                                    <div class="mil-secrc-text">
                        ...
                        <div class="col-sm-6">
                            ...
                            <div class="mil-team-card mil-up mil-mb-30">
                                <img src="<?php echo get_template_directory_uri() ?>/img/faces/2.jpg" alt="Team member">
                                <div class="mil-description">
                                    <div class="mil-secrc-text">
                            ...
                            <div class="mil-team-card mil-up mil-mb-30">
                                <img src="<?php echo get_template_directory_uri() ?>/img/faces/4.jpg" alt="Team member">
                                <div class="mil-description">
                                    <div class="mil-secrc-text">
    ...
    <div class="container mil-p-120-120">
        ...
        <div class="row">
            <div class="col-lg-10">
                ...
                <span class="mil-suptitle mil-suptitle-right mil-suptitle-dark mil-up">Customer reviews are
                    a valuable source <br>of information for both businesses and consumers.</span>
                            ...
                            while ($reviews_query->have_posts()):
                                ...
                                <div class="swiper-slide">
                                    <div class="mil-review-frame mil-center" data-swiper-parallax="-200"
                                        ...
                                        <p class="mil-mb-5 mil-upper mil-up mil-mb-30"><?php echo get_field('company') ?></p>
                        ...
                        <div class="swiper-slide">
                            <div class="mil-review-frame mil-center" data-swiper-parallax="-200"
                                ...
                                <p class="mil-text-xl mil-up">This creative agency stands out with their
                                    exceptional talent and expertise. Their ability to think outside the box
                                    and bring unique ideas to life is truly impressive. With meticulous
                                    attention to detail, they consistently deliver visually stunning and
                                    impactful work.</p>
                            </div>
                        </div>
                        <div class="swiper-slide">
        ...
        <div class="swiper-container mil-infinite-show mil-up">
            <div class="swiper-wrapper">
                ...
                $partners_query = new WP_Query(
                    array(
                        'post_type' => 'partner',
                        'posts_per_page' => -1, // Retrieve all partners
                    )
                );
                ...
                if ($partners_query->have_posts()):
                    while ($partners_query->have_posts()):
                        ...
                        ?>
                        <div class="swiper-slide">
                            <a href="<?php the_permalink(); ?>" class="mil-partner-frame">
